...
class Biofabric_lp_zachary{
    ...
    async fillObjectiveFunction(){
        ...
        await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", this.model.objective_function, 'utf8');
    }

    async fillModelTriplets(){
        await this.fillObjectiveFunction()
        await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "\nSubject to\n", 'utf8');
        this.model.bounds = "\nBinaries \n"
        ...
        for (let i = 0; i < this.g.nodes.length - 2; i++){
            ...
            for (let j = i + 1; j < this.g.nodes.length - 1; j++){
              for (let k = j + 1; k < this.g.nodes.length; k++){
                ...
                await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", y_ab + " + " + y_bc + " - " + y_ac + " >= 0\n", 'utf8');
                await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "- " + y_ab + " - " + y_bc + " + " + y_ac + " >= - 1\n", 'utf8');
              }
            }
          }
        ...
        for (let e1 of this.g.links){
            ...
            await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", pos_e1 + " = " + tmp_accumulator + "\n", 'utf8');
        }
        ...
        for (let n of this.g.nodes){
            ...
            for (let i = 0; i < adjacent_edges.length - 1; i++){
                for (let j = i + 1; j < adjacent_edges.length; j++){
                    ...
                    await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "pos_e" + edge2.id + " - pos_e" + edge1.id + " + " + this.m + " " + z1 + " <= " + (1 + this.m + 0.01) + "\n", 'utf8');
                    await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "pos_e" + edge2.id + " - pos_e" + edge1.id + " - " + this.m + " " + z1 + " >= " + (- 1 - this.m - 0.01) + "\n", 'utf8');

                    this.model.bounds += " " + z1 + ""

                    await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "pos_e" + edge1.id + " <= " + this.g.links.length + "\n", 'utf8');
                    await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "pos_e" + edge2.id + " <= " + this.g.links.length + "\n", 'utf8');
            ...
            for (let i = 0; i < adjacent_edges.length - 2; i++){
                for (let j = i + 1; j < adjacent_edges.length - 1; j++){
                    for (let k = j + 1; k < adjacent_edges.length; k++){
                        ...
                        await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", string_to_print, 'utf8');
        ...
        //         await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", cvars.join(" + ") + " <= 3\n", 'utf8');
        //     }
        ...
        //                         await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", cvar + " + " + cvar2 + " + " + cvar3 + " <= 2\n", 'utf8');
        //                     }
        //                 }
        //             }
        //         }
        ...
        //         let cvars = added_cvars.filter(c => c.includes("e" + edge_with_ni.id) && c.includes("e" + edge_with_nj.id) && c.includes("e" + edge_with_nk.id))

        //         // this.model.subjectTo += cvars.join(" + ") + " >= 1\n"
        //         await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", this.model.subjectTo += cvars.join(" + ") + " >= 1\n", 'utf8');
        //     }
        // }

        await this.add_zachary_statements();

        // print bounds in file
        await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", this.model.bounds, 'utf8');
    }

    async add_zachary_statements(){
        let statements = [
            "pos_e50 = 14\n",
            "pos_e77 = 15\n",
            // "pos_e70 = 16\n",
        ...
        for (let s of statements){
            await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", s, 'utf8');
        }
    }
    ...
    async addTransitivityConstraintsX(added_xvars, varname = "x"){
        ...
        for (let i = 0; i < this.g.links.length - 2; i++){
            ...
            for (let j = i + 1; j < this.g.links.length - 1; j++){
                ...
                await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", x_ab + " + " + x_bc + " - " + x_ac + " >= 0\n", 'utf8');
                await fs.appendFileSync("./zachary/zachary_problem/zachary.lp", "- " + x_ab + " - " + x_bc + " + " + x_ac + " >= - 1\n", 'utf8');
                }
            }
        }
    }
    ...
    makeModelRunways(){
        ...
        this.addTransitivityConstraintsX(added_xvars);
    ...
    makeModelAdjacencyx(){
        ...
        // add transitivity constraints on x
        this.addTransitivityConstraintsX(added_xvars, "x");
...
try {
    module.exports = exports = Biofabric_lp_zachary;
 } catch (e) {}